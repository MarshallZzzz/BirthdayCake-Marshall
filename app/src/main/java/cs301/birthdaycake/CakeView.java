...
public class CakeView extends SurfaceView {
    ...
    //a getter method of CakeModel object that returns a CakeModel
    CakeModel getModel(){
        return model;
    }
    ...
    public void drawBalloon(Canvas canvas, float x, float y){
        RectF rectum = new RectF(x - balloonWidth/2, y - balloonHeight/2, x + balloonWidth/2, y + balloonHeight/2);
        canvas.drawOval(rectum, balloonPaint);
        canvas.drawRect(x , y + balloonHeight/2, x + 10.0f, y + 300.0f, wickPaint );
    }
}//class CakeView
